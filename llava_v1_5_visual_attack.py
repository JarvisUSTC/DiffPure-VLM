...
from vlm_interface.LLaVA import load_model
args = parse_args()

print('model = ', args.model_path)

model, tokenizer, image_processor = load_model(args.model_path)
# freeze model
...
from llava_v1_5_utils import visual_attacker
...
from llava_v1_5_utils import prompt_wrapper
...
if args.constrained:
    save_image(adv_img_prompt, f'{args.save_dir}/LLaVA-v15-7B-eps{args.eps}-alpha{args.alpha}-iters{args.n_iters}-constrained.bmp')
else:
    save_image(adv_img_prompt, f'{args.save_dir}/LLaVA-v15-7B-alpha{args.alpha}-iters{args.n_iters}-unconstrained.bmp')
print('[Done]')
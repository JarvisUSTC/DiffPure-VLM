...
# 限制可见GPU
nohup bash -c "CUDA_VISIBLE_DEVICES=0 python omi_general_inference_jailguard.py --model_path $model_path --gpu-id 0 --image_file $image_prompt_path --input_file harmful_corpus/rtp_prompts.jsonl --output_file $output_path/rtp_prompts_challenges.jsonl" > $output_path/output.log 2>&1 &
